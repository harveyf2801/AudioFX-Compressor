/*
  ==============================================================================
    ...
    CustomLookAndFeelOld.cpp
    Author:  Harvey Fretwell

  ==============================================================================
*/

#include "CustomLookAndFeelOld.h"

void CustomLookAndFeelOld::drawRotarySlider(juce::Graphics& g, int x, int y, int width, int height,
...
void CustomLookAndFeelOld::drawLinearSlider(juce::Graphics& g, int x, int y, int width, int height,
...
void CustomLookAndFeelOld::drawBubble(juce::Graphics& g, juce::BubbleComponent& bubble,
...
void CustomLookAndFeelOld::drawButtonBackground(juce::Graphics& g, juce::Button& button,
