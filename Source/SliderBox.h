...
class SliderBox  : public juce::Component
{
    /* Creating a custom component to hold all the sliders in a flex box. */
...
private:
    ...
    LabeledSlider ingainSlider, outgainSlider;
    
    // Asserts an error if the object is coppied ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (SliderBox)
};
